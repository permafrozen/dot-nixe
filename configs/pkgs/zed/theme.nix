      ...
      "themes": [
        {
          ...
          "style": {
            ...
            "element.active": "#${config.stylix.colors.base02}",
            "element.selected": "#${config.stylix.colors.base02}",
            ...
            "ghost_element.active": "#${config.stylix.colors.base02}",
            "ghost_element.selected": "#${config.stylix.colors.base02}",
            ...
            "search.match_background": "#${config.stylix.colors.base0A}",
            ...
            "scrollbar.track.border": "#${config.stylix.colors.base00}",
            ...
            "editor.active_line.background": "#${config.stylix.colors.base00}",
            ...
            "editor.wrap_guide": "#${config.stylix.colors.base05}",
            "editor.active_wrap_guide": "#${config.stylix.colors.base05}",
            "editor.document_highlight.read_background": "#${config.stylix.colors.base0C}",
            ...
            "terminal.ansi.bright_black": "#${config.stylix.colors.base02}",
            ...
            "info.background": "#${config.stylix.colors.base0C}",
            ...
            "renamed.background": "#${config.stylix.colors.base0C}",
