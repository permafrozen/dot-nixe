        ...
        "themes": [
          {
            ...
            "style": {
              ...
              "border.variant": "#${config.lib.stylix.colors.base02}",
              "border.focused": null,
              ...
              "tab.inactive_background": "#${config.lib.stylix.colors.base01}",
              ...
              "scrollbar.thumb.background": "#${config.lib.stylix.colors.base02}",
              "scrollbar.thumb.hover_background": "#${config.lib.stylix.colors.base03}",
              "scrollbar.thumb.border": "#${config.lib.stylix.colors.base02}6f",
              "scrollbar.track.background": "#${config.lib.stylix.colors.base00}",
